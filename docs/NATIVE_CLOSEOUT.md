...
| `C2`       | Validate the full Windows native release gate on a real Windows host | Release Engineer            | Pending real-host execution                                                                                                                                      | Complete only when `npm run native:release:win:local` exits `0` and the Windows release artifacts are written under `release/`             |
