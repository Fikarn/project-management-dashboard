...
Do not treat it as a release path. The native desktop runtime became the sole release-ready path after the `v2.0.0` to `v2.0.1-rc.4` upgrade validation completed on `2026-04-18`.
