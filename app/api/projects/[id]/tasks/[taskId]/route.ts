  ...
  const db = await mutateDB((db) => {
    ...
    const updated = {
      ...
      tasks: db.tasks.map((t) => {
        ...
        if (body.dueDate !== undefined) { next.dueDate = body.dueDate; changes.push("dueDate"); }
        if (body.labels !== undefined) { next.labels = body.labels; changes.push("labels"); }
        if (body.completed !== undefined) { next.completed = body.completed; changes.push("completed"); }
